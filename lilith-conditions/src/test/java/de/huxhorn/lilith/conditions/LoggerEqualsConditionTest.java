...
class LoggerEqualsConditionTest {
    ...
    private static Stream<Arguments> corpusCases() {
        return Stream.of(
                ...
                Arguments.of("com", ConditionTestSupport.setOf()),
                Arguments.of("com.foo", ConditionTestSupport.setOf()),
    ...
    void serializationRoundTrip(String searchString) {
        LoggerEqualsCondition condition = new LoggerEqualsCondition();
        condition.setSearchString(searchString);

        LoggerEqualsCondition result = ConditionTestSupport.serialize(condition);
    ...
    void xmlSerializationRoundTrip(String searchString) {
        ...
        LoggerEqualsCondition result = ConditionTestSupport.xmlSerialize(condition);
    ...
    void cloningRetainsSearchString(String searchString) {
        ...
        LoggerEqualsCondition result = ConditionTestSupport.cloneCondition(condition);
    ...
    void equalsBehavesAsExpected() {
        LoggerEqualsCondition instance = new LoggerEqualsCondition();
        LoggerEqualsCondition other = new LoggerEqualsCondition("foo");
