...
class LoggerStartsWithConditionTest {
    ...
    void serializationRoundTrip(String searchString) {
        LoggerStartsWithCondition condition = new LoggerStartsWithCondition();
        condition.setSearchString(searchString);

        LoggerStartsWithCondition result = ConditionTestSupport.serialize(condition);
    ...
    void xmlSerializationRoundTrip(String searchString) {
        ...
        LoggerStartsWithCondition result = ConditionTestSupport.xmlSerialize(condition);
    ...
    void cloningRetainsSearchString(String searchString) {
        ...
        LoggerStartsWithCondition result = ConditionTestSupport.cloneCondition(condition);
    ...
    void equalsBehavesAsExpected() {
        LoggerStartsWithCondition instance = new LoggerStartsWithCondition();
        LoggerStartsWithCondition other = new LoggerStartsWithCondition("foo");
