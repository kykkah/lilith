...
class ThreadGroupNameConditionTest {
    ...
    void serializationRoundTrip(String searchString) {
        ThreadGroupNameCondition condition = new ThreadGroupNameCondition();
        condition.setSearchString(searchString);

        ThreadGroupNameCondition result = ConditionTestSupport.serialize(condition);
    ...
    void xmlSerializationRoundTrip(String searchString) {
        ...
        ThreadGroupNameCondition result = ConditionTestSupport.xmlSerialize(condition);
    ...
    void cloningRetainsSearchString(String searchString) {
        ...
        ThreadGroupNameCondition result = ConditionTestSupport.cloneCondition(condition);
    ...
    void equalsBehavesAsExpected() {
        ThreadGroupNameCondition instance = new ThreadGroupNameCondition();
        ThreadGroupNameCondition other = new ThreadGroupNameCondition("foo");
