...
class LoggerContainsConditionTest {
    ...
    private static Stream<Arguments> corpusCases() {
        return Stream.of(
                ...
                Arguments.of("foo", ConditionTestSupport.setOf(13, 14)),
    ...
    void serializationRoundTrip(String searchString) {
        LoggerContainsCondition condition = new LoggerContainsCondition();
        condition.setSearchString(searchString);

        LoggerContainsCondition result = ConditionTestSupport.serialize(condition);
    ...
    void xmlSerializationRoundTrip(String searchString) {
        ...
        LoggerContainsCondition result = ConditionTestSupport.xmlSerialize(condition);
    ...
    void cloningRetainsSearchString(String searchString) {
        ...
        LoggerContainsCondition result = ConditionTestSupport.cloneCondition(condition);
    ...
    void equalsBehavesAsExpected() {
        LoggerContainsCondition instance = new LoggerContainsCondition();
        LoggerContainsCondition other = new LoggerContainsCondition("foo");
