...
class MessagePatternEqualsConditionTest {

    @ParameterizedTest(name = "searchString={0}")
    @MethodSource("corpusCases")
    void corpusWorks(String searchString, Set<Integer> expected) {
        MessagePatternEqualsCondition condition = new MessagePatternEqualsCondition(searchString);
    ...
    private static Stream<Arguments> corpusCases() {
        return Stream.of(
                ...
                Arguments.of("{}", ConditionTestSupport.setOf(22, 23)));
    }

    @ParameterizedTest(name = "serialize search={0}")
    @MethodSource("inputValues")
    void serializationRoundTrip(String searchString) {
        MessagePatternEqualsCondition condition = new MessagePatternEqualsCondition();
        condition.setSearchString(searchString);

        MessagePatternEqualsCondition result = ConditionTestSupport.serialize(condition);
    ...
    void xmlSerializationRoundTrip(String searchString) {
        ...
        MessagePatternEqualsCondition result = ConditionTestSupport.xmlSerialize(condition);
    ...
    void cloningRetainsSearchString(String searchString) {
        ...
        MessagePatternEqualsCondition result = ConditionTestSupport.cloneCondition(condition);
    ...
    void equalsBehavesAsExpected() {
        MessagePatternEqualsCondition instance = new MessagePatternEqualsCondition();
        MessagePatternEqualsCondition other = new MessagePatternEqualsCondition("foo");
