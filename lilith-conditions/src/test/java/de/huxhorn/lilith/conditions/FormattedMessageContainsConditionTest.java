...
class FormattedMessageContainsConditionTest {

    @ParameterizedTest(name = "searchString={0}")
    @MethodSource("corpusCases")
    void corpusWorks(String searchString, Set<Integer> expected) {
        FormattedMessageContainsCondition condition = new FormattedMessageContainsCondition(searchString);
    ...
    private static Stream<Arguments> corpusCases() {
        return Stream.of(
                ...
                Arguments.of("message", ConditionTestSupport.setOf(17, 18, 19, 20, 21)),
                Arguments.of("a message", ConditionTestSupport.setOf(17, 19, 20, 21)),
                Arguments.of("another message", ConditionTestSupport.setOf(18)),
                Arguments.of("a message.", ConditionTestSupport.setOf(17)),
                Arguments.of("another message.", ConditionTestSupport.setOf(18)),
                Arguments.of("paramValue", ConditionTestSupport.setOf(19, 21, 22)),
                Arguments.of("{}", ConditionTestSupport.setOf(20, 21, 23)));
    }

    @ParameterizedTest(name = "serialize search={0}")
    @MethodSource("inputValues")
    void serializationRoundTrip(String searchString) {
        FormattedMessageContainsCondition condition = new FormattedMessageContainsCondition();
        condition.setSearchString(searchString);

        FormattedMessageContainsCondition result = ConditionTestSupport.serialize(condition);
    ...
    void xmlSerializationRoundTrip(String searchString) {
        ...
        FormattedMessageContainsCondition result = ConditionTestSupport.xmlSerialize(condition);
    ...
    void cloningRetainsSearchString(String searchString) {
        ...
        FormattedMessageContainsCondition result = ConditionTestSupport.cloneCondition(condition);
    ...
    void equalsBehavesAsExpected() {
        FormattedMessageContainsCondition instance = new FormattedMessageContainsCondition();
        FormattedMessageContainsCondition other = new FormattedMessageContainsCondition("foo");
