...
/**
 * Temporary shadow plugin override until the upstream project migrates to the Gradle 9 file permission APIs.
 * This mirrors Shadow 8.1.1 but replaces deprecated file mode access with the new {@code filePermissions} API.
 */
