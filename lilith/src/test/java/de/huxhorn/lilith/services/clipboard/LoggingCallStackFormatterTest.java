...
class LoggingCallStackFormatterTest extends AbstractClipboardFormatterTest {

    @Override
    protected LoggingCallStackFormatter createInstance() {
        return new LoggingCallStackFormatter();
    }

    @Override
    protected Set<Integer> expectedIndices() {
        return Set.of(44, 45, 46, 47, 48, 49, 50, 51, 65, 66, 116);
    }
