...
/**
* Base formatter that produces HTML snippets for details views.
	*/
		...
		implements BasicFormatter
{
	...
	/**
	* Creates an HTML snippet describing an error.
 *
* @param message         headline message
* @param additionalInfo  optional extra information
* @param throwable       optional throwable to render
* @return HTML representation of the error
	*/
